...
<body>
    ...
    <script>
        ...
        var path = '../web/imagens/<?php echo $_GET['id'].'/'.$_GET['id_anuncio'].'/';?>';
 ...
 || navigator.userAgent.match(/Windows Phone/i)
     ...
     pdt360DegViewer('car7', 72, path, 'jpg', false, false, false, false, false, true, true); 
  }
 else {
    pdt360DegViewer('car7', 72, path, 'jpg', false, false, true, true, true, true, true); 
  }
